...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-28 04:56`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/87d3d275-0bca-4d75-bb3a-0a2ad3fcb503.git
$ cd 87d3d275-0bca-4d75-bb3a-0a2ad3fcb503
```
